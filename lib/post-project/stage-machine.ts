...
const allowedActionsByStage: Record<PostStage, PostAction[]> = {
  ...
  evidence_ready: ["retrieve_viral_knowledge", "create_creative_brief", "search_research", "update_brief_inputs", "recover"],
  brief_ready: ["generate_copy", "plan_visuals", "retrieve_viral_knowledge", "update_brief_inputs", "recover"],
  copy_drafting: ["revise_copy", "recover"],
  copy_ready: ["revise_copy", "plan_visuals", "generate_cards", "retrieve_viral_knowledge", "assemble_post", "recover"],
  visual_planning: ["confirm_visual_direction", "generate_image_prompts", "revise_copy", "recover"],
  image_prompt_ready: ["confirm_visual_direction", "generate_images", "generate_cards", "plan_visuals", "recover"],
